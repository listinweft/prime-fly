<div class="col-12 header{{ Request::is('cart', 'checkout','preview','terms-and-conditions','package','privacy-policy','package/*') ? ' header-cart' : '' }}">
   <div class="container">
      <header class="d-flex flex-wrap justify-content-center align-items-center py-2">
         ...
         @if(Request::is('cart', 'checkout','preview','terms-and-conditions','package','privacy-policy','package/*'))
