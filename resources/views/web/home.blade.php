...
<section class="col-12 banner">
                     ...
                     <div class="col-lg-10">
                        ...
                        <div class="banner_filter" data-aos="fade-up" data-aos-duration="1000">
                           ...
                           <li class="nav-item col" role="presentation">
                                 <button class="nav-link active" id="meet-and-greet-tab" data-bs-toggle="pill" data-bs-target="#meet-and-greet-tab-pane" type="button" role="tab" aria-controls="meet-and-greet-tab-pane" aria-selected="false">
                              ...
                              <li class="nav-item col" role="presentation">
                                 <button class="nav-link" id="Baggage-Wrapping-tab" data-bs-toggle="pill" data-bs-target="#Baggage-Wrapping-tab-pane" type="button" role="tab" aria-controls="Baggage-Wrapping-tab-pane" aria-selected="true">
                              ...
                              <li class="nav-item col" role="presentation">
                                 <button class="nav-link" id="Car-Parking-tab" data-bs-toggle="pill" data-bs-target="#Car-Parking-tab-pane" type="button" role="tab" aria-controls="Car-Parking-tab-pane" aria-selected="false">
                              ...
                              <li class="nav-item col" role="presentation">
                                 <button class="nav-link" id="airport-tab" data-bs-toggle="pill" data-bs-target="#airport-tab-pane" type="button" role="tab" aria-controls="airport-tab-pane" aria-selected="false">
                              ...
                              <li class="nav-item col" role="presentation">
                                 <button class="nav-link" id="cloak-tab" data-bs-toggle="pill" data-bs-target="#cloak" type="button" role="tab" aria-controls="cloak" aria-selected="false">
                              ...
                              <li class="nav-item col" role="presentation">
                                 <button class="nav-link" id="porter-tab" data-bs-toggle="pill" data-bs-target="#porter-tab-pane" type="button" role="tab" aria-controls="porter-tab-pane" aria-selected="false">
       ...
       @endphp
                              ...
                              <div class="tab-pane fade" id="cloak" role="tabpanel" aria-labelledby="cloak-tab" tabindex="0">
