...
@endif
               ...
               <div>
                   <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="kerala_location" id="inside_kerala_b2b" value="Inside" checked>
                           <label class="form-check-label" for="gender_static_mr">Inside Kerala</label>
                           </div>
                           <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="kerala_location" id="outside_kerala_b2b" value="Outside">
                           <label class="form-check-label" for="gender_static_ms">Outside Kerala</label>
                           </div> 
               <!--<input type="radio" name="kerala_location" id="inside_kerala_b2b" value="Inside"><label>Inside Kerala</label>-->
               <!--<input type="radio" name="kerala_location" id="outside_kerala_b2b" value="Outside"><label>Oustside Kerala</label>-->
               </div>
               </div>
               ...
               <div class="price-summery customer-detail-form">
               <div class="details-item">
                  <div class="details-item ps-2 pe-2 mt-3 mb-2"> 
                   <div>
                       <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="kerala_location" id="inside_kerala_else" value="Inside" checked>
                           <label class="form-check-label m-0" for="gender_static_mr">Inside Kerala</label>
                           </div>
                           <div class="form-check form-check-inline">
                           <input class="form-check-input" type="radio" name="kerala_location" id="outside_kerala_else" value="Outside">
                           <label class="form-check-label m-0" for="gender_static_ms">Outside Kerala</label>
                           </div> 
                   </div>
               </div>
               <div class="details-item  ps-2 pe-2">
            ...
            <tr>
            <td>{{$row->name}}</td>
            <td>&#8377; {{ number_format(round($row->price - ($row->price * 0.09) - ($row->price * 0.09)), 2, '.', ',') }}</td>
...
<script>
   ...
   const toggleTaxRows = function () {
       ...
       if (selectedLocation === 'Inside') { // Correct case matching to 'Inside'
           $('.cgst-sgst-row').css('display', 'table-row'); // Show CGST and SGST rows
           $('.igst-row').css('display', 'none');           // Hide IGST row
       } else if (selectedLocation === 'Outside') { // Correct case matching to 'Outside'
