    ...
    <ul class="calc_area">
        ...
        <li class="cod-charge" style="display:none;">
            ...
            <div class="right">
                <h5 class="shipping_amount">{{Helper::defaultCurrency()}} {{Helper::defaultCurrencyRate()*$siteInformation->cod_extra_charge}}</h5>
            </div>
        </li>
        <li>
            <div class="left">
                ...
                <li class="flex-column justify-content-end align-items-end couponDiscount">
                    <div class="d-flex w-100 justify-content-between">
                        ...
                        <div class="right">
                            ...
                            <h6 class="tableData">- {{Helper::defaultCurrency()}} {{number_format(Helper::defaultCurrencyRate()*$session_coupon['coupon_value'],2)}}</h6>
                        </div>
                    </div>
