<div class="modal fade login_create" id="get_quote_form_pop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"> <i class="fa-solid fa-list"></i> Get A Quote</h5>
            ...
            <div class="modal-body">
                <form action="" id="getQuoteForm" name="getQuoteForm">
                    <div class="row">
                        ...
                        <input type="hidden" id="type" name="type" value="get_a_quote">
                        <div class="form-group">
