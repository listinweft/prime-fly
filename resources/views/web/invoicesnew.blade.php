...
@php
          ...
          @endphp
    <header id="header">
        <table style="width: 100%;background-color:#05233d;max-width:720px;margin:auto;padding: 30px;">
            <tr>
    ...
    <tbody>
        @foreach ($order->orderProducts as $product)
            <tr>
                ...
                @if($order->orderProducts->contains(fn($item) => !empty($item->flight_number)))
