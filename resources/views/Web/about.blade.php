        ...
        <div class="row align-items-start">
            <div class="col-lg-5 position-relative pb-50">
                <div class="aboutImageBox">
                    <img class="img-fluid w-100" src="{{ asset('frontend/images/aboutImage.jpg')}}" alt="">
                </div>
                <div class="artLog">
...
<section class="aboutAdd">
    <a href="#">
        <img class="img-fluid" src="{{ asset('frontend/images/aboutBanner.jpg')}}" alt="">
    </a>
</section>
            ...
            <div class="col-lg-12 sliderClass position-relative">
                ...
                <div class="shopCategorySlider">
                    <div class="shopSectionItem shopSectionItemBg1">
                        <div class="wrapper">
                            <div class="imgBox">
                                <img class="img-fluid" src="{{ asset('frontend/images/themes/theme-01.jpg')}}" alt="">
                            </div>
                            <h5>Portraits</h5>
                            <h6>17 Items</h6>
                        </div>
                    ...
                    <div class="shopSectionItem shopSectionItemBg2">
                        <div class="wrapper">
                            <div class="imgBox">
                                <img class="img-fluid" src="{{ asset('frontend/images//themes/theme-02.jpg')}}" alt="">
                            </div>
                            <h5>Landscapes</h5>
                            <h6>23 Items</h6>
                        </div>
                    ...
                    <div class="shopSectionItem shopSectionItemBg3">
                        <div class="wrapper">
                            <div class="imgBox">
                                <img class="img-fluid" src="{{ asset('frontend/images/themes/theme-03.jpg')}}" alt="">
                            </div>
                            <h5>Seascapes</h5>
                            <h6>27 Items</h6>
                        </div>
                    ...
                    <div class="shopSectionItem shopSectionItemBg4">
                        <div class="wrapper">
                            <div class="imgBox">
                                <img class="img-fluid" src="{{ asset('frontend/images/themes/theme-04.jpg')}}" alt="">
                            </div>
                            <h5>Flowers</h5>
                            <h6>32 Items</h6>
                        </div>
                    ...
                    <div class="shopSectionItem shopSectionItemBg5">
                        <div class="wrapper">
                            <div class="imgBox">
                                <img class="img-fluid" src="{{ asset('frontend/images/themes/theme-05.jpg')}}" alt="">
                            </div>
                            <h5>Animals</h5>
                            <h6>12 Items</h6>
                        </div>
                    ...
                    <div class="shopSectionItem shopSectionItemBg6">
                        <div class="wrapper">
                            <div class="imgBox">
                                <img class="img-fluid" src="{{ asset('frontend/images/themes/theme-06.jpg')}}" alt="">
                            </div>
                            <h5>Birds</h5>
                            <h6>30 Items</h6>
                        </div>
