                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                <a href="{{url(Helper::sitePrefix().'gallery/create/')}}"
                            ...
                            <div class="card-body">
                                <table class="table table-bordered table-hover dataTable">
                                    ...
                                    <tbody>
                                    @foreach($categoryList as $gallery)
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch">
                                                    <input type="checkbox" class="status_check"
                                                           data-url="/status-change" data-table="Gallery"
                                            ...
                                            <td>
                                                <input type="text" name="gallery_order"
                                                       ...
                                                       data-table="Gallery" data-id="{{ $gallery->id }}"
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{url(Helper::sitePrefix().'gallery/edit/'.$gallery->id)}}"
                                                       class="btn btn-success mr-2 tooltips" title="Edit Gallery"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips"
                                                       title="Delete Gallery" data-url="gallery/delete"
