                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                <a href="{{url(Helper::sitePrefix().'about/honarary/create')}}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="{{url(Helper::sitePrefix().'about/honarary/edit/'.$aboutFeature->id)}}"
                                                       class="btn btn-success mr-2 tooltips" title="Edit About Feature"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips"
                                                       title="Delete About Feature" data-url="about/honarary/delete"
