    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><i class="nav-icon fas fa-user-shield"></i> Manage Frame</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-success card-outline">
                            <div class="card-header">
                                <a href="{{url(Helper::sitePrefix().'product/frame/create')}}"
                                   class="btn btn-success pull-right">Add Frame <i
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="sort_order"
                                                       ...
                                                       data-table="Frame" data-id="{{ $frame->id }}"


                                                       class="common_sort_order" style="width:25%"
                                                       value="{{$frame->sort_order}}">
                                            </td>
                                            <td>
                                                <label class="switch">
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips"
                                                       ...
                                                       title="Delete Frame"><i class="fas fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
