    ...
    <table style=" width: 100%; background-color: #fff;max-width:680px;margin:auto;font-family: sans-serif;">
        <tr>
            <td style="padding: 30px 0;">
                <img style="width:100%" src="https://primefly.in/public/frontend/images/feedback_banner.png" alt="Logo" style="width: 100px; height: auto;">
            </td>
        <tr>
       <tr> 
            <td style="padding-bottom: 15px; padding:25px 50px 0;">
                <h4 style="margin-bottom: 5px; font-size: 22px;">Dear {{$name}},</h4>
                <p style="color: #000;line-height: 1.6;font-size: 16px;margin-bottom: 10px;    font-weight: 400;">Thank you for giving PrimeFly the opportunity to assist you at the airport.</p>
                <p style="color: #000;line-height: 1.6;font-size: 16px;font-weight: 400;margin-bottom: 20px;">Your feedback means a lot to us and will help us enhance our service and provide you with an even better experience next time.</p>
        ...
        <tr>
            <td style="padding:25px 50px;background-image: linear-gradient(to right, #8A008E, #00328D);">
                <p style="margin-bottom:0px;font-size: 17px;color: #fff;">
                    At PrimeFly, we’re dedicated to making your airport journey smooth, stress-free, and comfortable from start to finish.
                </p>
            </td>
        </tr> 
        <tr>
            <td style="padding: 0 50px;">
                <p style="margin-top: 30px; margin-bottom:10px;font-size: 16px;font-weight: 400;">
                    We truly value your opinion and look forward to hearing from you soon.</p>
            </td>
        </tr>
        <tr>
