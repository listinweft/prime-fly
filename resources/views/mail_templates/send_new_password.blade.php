        ...
        <tbody style="background-color: #ffffff;width: 100%;">
            ...
            <tr>
                <td style="padding:10px 60px;width: 100%;text-align: center;"> 
                        <p style="color: #4C4C4D;font-size: 14px;line-height: 1.4;margin: 0;">Your New Password is:</p>
                         
                </td>
            </tr> 
            <tr align="center" valign="top">
                <td valign="middle" colspan="5" style="padding: 0 60px; padding-top: 15px;text-align:center;">
                      <p style="font-weight: bold;margin-top: 0;">Password: {password}</p>
                </td>
            </tr>
            <tr>
