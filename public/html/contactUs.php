        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h6 class="subHeading">Contact Us</h6>
                    <h2 class="mainHeading">Let’s Connect</h2>
                ...
                <div class="col-12">
                    <div class="contactWrapper">
                        <div class="contactItem text-center">
                            ...
                            <ul>
                                <li>
                                    <a href="tel:+971000000000">+971 000 0000</a>
                                </li>
                                <li>
                                    <a href="tel:+971000000000">+971 000 0000</a>
                                </li>
                        ...
                        <div class="contactItem text-center">
                            ...
                            <ul>
                                <li>
                                    <a href="mailto:info@artemyst.com" >info@artemyst.com</a>
                                </li>
                                <li>
                                    <a href="mailto:sales@artemyst.com" >sales@artemyst.com</a>
                                </li>
                            </ul>
                        </div>
                    </div>
