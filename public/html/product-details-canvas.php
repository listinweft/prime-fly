                            ...
                            <div class="item position-relative">
                                <div class="fotorama__stage__frame fotorama__loaded magnify-wheel-loaded fotorama__active" >
                                    <div class="fotorama__html">
                                        <img class="art-canvas fotorama__img" src="assets/images/product/product05.jpg" aria-hidden="false">
                                    </div>
                                </div>
                            </div>
                            <div class="item position-relative">
                                <div class="fotorama__stage__frame fotorama__loaded magnify-wheel-loaded fotorama__active" >
                                    <div class="fotorama__html">
                                        <img class=" fotorama__img" src="assets/images/frame/canvas.jpg" aria-hidden="false">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="productDetailsThumbs">
                            ...
                            <div class="fotorama__nav__frame ">
                                <div class="fotorama__thumb fotorama_vertical_ratio fotorama__loaded fotorama__loaded--img">
                                    <img src="assets/images/frame/canvas.jpg" class="fotorama__img">
                                </div>
                            </div>
                        </div>
                    </div>
