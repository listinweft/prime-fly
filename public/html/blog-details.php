...
<!--Inner Banner Start-->
    <section class="innerBanner">
        <div class="innerBannerImageArea">
            <img class="bannerImg img-fluid" src="assets/images/banner/banner-03.jpg" alt="">
        </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Lorem Ipsum is simply dummy text</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="textArea">
                        <p>
                            ...
                            a galley of type and <a href="">scrambled it to make</a> a type specimen book. It has survived not only
                    ...
                    <div class="video-area">
                        <img class="img-fluid blogImg" src="assets/images/blog/blog-01-2.jpg" alt="">
                        <a href="https://youtu.be/mAHqElyW79c" data-fancybox="group">
                            <button type="button" class="video-btn">
                                <img class="img-fluid" src="assets/images/videoPlay.png" alt="">
                            </button>
                        </a>
                    </div>
                    <div class="textArea">
