...
class EventController extends Controller
{
    ...
    public function event_create()
    {
        ...
        return view('Admin.eventview.form', compact('key', 'title'));
    }
...
//        $blog->banner_sub_title = $request->banner_sub_title ?? '';
       ...
       $other_meta_tag =   $blog->other_meta_tag = ($request->other_meta_tag) ? $request->other_meta_tag : '';
        ...
        if ($blog->save()) {
            session()->flash('success', 'Event "' . $request->title . '" has been added successfully');
            return redirect(Helper::sitePrefix() . 'event/');
        } else {
...
//        $blog->banner_sub_title = $request->banner_sub_title ?? '';
        ...
        if ($blog->save()) {
            session()->flash('success', 'event "' . $request->title . '" has been updated successfully');
            return redirect(Helper::sitePrefix() . 'event/');
        } else {
